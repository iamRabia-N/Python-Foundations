...
print (py_dictionary["var2"]) # value lookup
# Output: "string"
...
print (py_dictionary) 
# Output: {'var2': 'string', 'var3': 'float'}

py_dictionary["var2"] = "bool" # updates an entry
print (py_dictionary)  
# Output: {'var2': 'bool', 'var3': 'float'}

py_dictionary["new_var_added"] = "array" # adds an entry
print (py_dictionary)
# Output: {'var2': 'bool', 'var3': 'float', 'new_var_added': 'array'}


print (len(py_dictionary)) # provides the number of keys
# Output: 3
...
print (py_dictionary.keys()) # creates a list of keys. Very used in for statements. ["a","b","c"]
# Output: dict_keys(['a', 'b', 'c'])

print (py_dictionary.values()) # creates a list of values
# Output: dict_values([10, 20, 30])

print (py_dictionary.items()) # creates a tuple with the dictionary elements
# Output: dict_items([('a', 10), ('b', 20), ('c', 30)])

print (py_dictionary.has_key("a")) # returns 1 if key exists. Otherwise it returns 0.
# Output: 1

# dic.get(value, default)
# If key exists, returns its value. Otherwise it returns the second arg. 
print (py_dictionary.get("b", None))
# Output: 20
...
# Python 2.0 contains a brand-new method for dictionaries, which is called setdefault(). This method returns the value for the given key (exactly as the get() method would do). However, if the given key is not
