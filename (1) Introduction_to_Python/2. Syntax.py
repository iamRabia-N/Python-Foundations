...
# 1.	Declaring the type of a variable is not required in Python. Because it is reinitialized every time a value is given to it, the same variable name can have different types at different times. For example:
